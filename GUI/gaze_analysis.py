...
from Analysis.process_data import clean_data
...
QComboBox:editable {
    background: white;
        ...
        self.dropdown.currentIndexChanged.connect(
            self.toggle_event_analytics_options)
        ...
        self.button4.clicked.connect(self.on_button_pressed)
